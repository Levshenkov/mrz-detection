...
async function loadData(dir) {
  const { readImages } = await import('../src/util/readWrite')
...
async function predictImages(images, modelName) {
...
export { applyModel, createModel, train, predict, extractHOG, predictImages, loadData }
